...
?>
						...
						<div class="stats-right">
							<label><?php if(!empty($totalaccapt)){
								echo $totalaccapt;
							}else{
								echo'0';
							}?></label>
...
?>
						...
						<div class="stats-right">
							<label> <?php if(!empty($totalrejapt)){
								echo $totalrejapt;
							}else{
								echo'0';
							}?></label>
...
$yesterdaysale+=$yesterdays_sale;
 ...
 ?>
						...
						<div class="stats-right">
							<label> <?php if(!empty($yesterdaysale)){
								echo $yesterdaysale;
							}else{
								echo'0';
							}?></label>
